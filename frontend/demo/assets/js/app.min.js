...
!(function (t, e) {
  ...
  function j(t, e, i) {
    var n = "string" == typeof e,
      ...
      s = t.replace(C, ""),
      r = O[s];
    return r && (s = r), L.has(s) || (s = t), [n, o, s];
  }
  function $(t, e, i, n, o) {
  ...
  M.on(
    ...
    b(function () {
      ...
      if (t) {
        var e = t.fn[N];
        (t.fn[N] = W.jQueryInterface),
          (t.fn[N].Constructor = W),
  ...
  M.on(
    ...
    b(function () {
      ...
      if (t) {
        var e = t.fn[Y];
        (t.fn[Y] = V.jQueryInterface),
          (t.fn[Y].Constructor = V),
          (t.fn[Y].noConflict = function () {
            return (t.fn[Y] = e), V.jQueryInterface;
          });
      }
    });
  var G = "collapse",
  ...
  function kt(t) {
    for (var e = dt(t), i = wt(t); i && yt(i) && "static" === vt(i).position; )
      i = wt(i);
  ...
  function Yt(t, e) {
    ...
    var i = e,
      ...
      S = "popper" === d ? T : w,
      C = {
        top: _.top - S.top + m.top,
        bottom: S.bottom - _.bottom + m.bottom,
        left: _.left - S.left + m.left,
        right: S.right - _.right + m.right,
      },
        ...
        if (k) {
          if (s) {
            var x = "y" === _ ? et : ot,
              ...
              W = H[I],
              B = St(0, T[O], M[O]),
              R = b ? T[O] / 2 - P - B - N - C : j - B - N - C,
              q = b ? -T[O] / 2 + P + B + W + C : $ + B + W + C,
              ...
              Q = k[_] + R - Y - U,
              K = k[_] + q - Y,
              X = St(f ? Math.min(A, Q) : A, L, f ? Math.max(z, K) : z);
            (k[_] = X), (E[_] = X - L);
          }
          if (a) {
            var V = "x" === _ ? et : ot,
  ...
  var oe = ne(),
    se = ne({ defaultModifiers: [zt, Zt, Lt, ft] }),
    re = ne({ defaultModifiers: [zt, Zt, Lt, ft, Gt, Qt, Jt, xt, Vt] }),
    ae = Object.freeze({
      __proto__: null,
      popperGenerator: ne,
      detectOverflow: Yt,
  ...
  var be = { backdrop: !0, keyboard: !0, focus: !0 },
    ...
    we = (function (t) {
      ...
      return (
        ...
        (s._getConfig = function (t) {
          return (t = i({}, be, t)), h("modal", t, _e), t;
        }),
  ...
  b(function () {
    ...
    if (t) {
      var e = t.fn[je];
      (t.fn[je] = Ne.jQueryInterface),
        (t.fn[je].Constructor = Ne),
        (t.fn[je].noConflict = function () {
          return (t.fn[je] = e), Ne.jQueryInterface;
        });
    }
  });
  var We = "scrollspy",
  ...
  M.on(window, "load.bs.scrollspy.data-api", function () {
    ...
    b(function () {
      ...
      if (t) {
        var e = t.fn[We];
        (t.fn[We] = qe.jQueryInterface),
          (t.fn[We].Constructor = qe),
          (t.fn[We].noConflict = function () {
            return (t.fn[We] = e), qe.jQueryInterface;
          });
      }
    });
  var Fe = (function (t) {
  ...
  return (
    b(function () {
      ...
      if (t) {
        var e = t.fn.toast;
        (t.fn.toast = Qe.jQueryInterface),
          (t.fn.toast.Constructor = Qe),
  ...
  (function (t, e) {
    ...
    return function n(a) {
      if (
        ...
        var T = t(l.height);
        return (
          !1 !== T && (c.height = T + (w ? 0 : g + _)),
          (c.innerWidth = c.width - (m + b)),
          (c.innerHeight = c.height - (g + _)),
    ...
    t.magnificPopup.registerModule("image", {
      ...
      proto: {
        ...
        getImage: function (i, n) {
          ...
          return (
            e._parseMarkup(n, { title: $(i), img_replaceWith: i.img }, i),
            e.resizeImage(),
            i.hasSize
              ? (j && clearInterval(j),
                i.loadError
        ...
        initRetina: function () {
          if (window.devicePixelRatio > 1) {
            var t = e.st.retina,
              i = t.ratio;
            (i = isNaN(i) ? i() : i) > 1 &&
              (_("ImageHasSize." + B, function (t, e) {
                e.img.css({
                  "max-width": e.img[0].naturalWidth / i,
                  width: "100%",
                });
              }),
              _("ElementParse." + B, function (e, n) {
          ...
          l(t, [
            {
              ...
              value: function () {
                (this.element = window.document.documentElement),
                  n(document.readyState, ["interactive", "complete"])
                    ? this.start()
                    : o(document, "DOMContentLoaded", this.start),
                  (this.finished = []);
              },
            },
            {
            ...
            },
            {
              ...
              value: function (t, e) {
                for (
                  var i = u(t), n = i.getPropertyCSSValue(e), o = 0;
            ...
            },
            {
              ...
              value: function (t) {
                ...
                try {
                  ...
                  e = u(t).getPropertyValue("animation-name");
                }
                return "none" === e ? "" : e;
              },
            },
