...
<div class="breadcumb-wrapper" data-bg-src="assets/img/bg/header-bg-1-1.jpg">
    <div class="container z-index-common">
        <div class="breadcumb-content">
            <h1 class="breadcumb-title">Asset Hierarchy </h1>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.3s">
                <h2 class="sec-title col-xl-9">Asset Hierarchy</h2>
                <p class="pe-3 fs-md">It may be easier than you think. Like other successful businesses, you’ll want
                ...
                <div class="service-box-list text-left">
                    <ul>
                        <li><i class="far fa-check-circle"></i>Maintenance and Reliability Engineering.</li>
                        <li><i class="far fa-check-circle"></i>Planning & Scheduling.</li>
                        <li><i class="far fa-check-circle"></i>Execution of maintenance.</li>
                        <li><i class="far fa-check-circle"></i>Operations.</li>
                        <li><i class="far fa-check-circle"></i>And Finance.</li>
                    </ul>
                </div>
                <p class="pe-3 fs-md">A clear and adequate hierarchy structure of assets (Taxonomy), according to
