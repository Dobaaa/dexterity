        ...
        <div class="row gx-60 align-items-center">
            ...
            <div class="col-lg-7 pt-5 pt-xl-0 wow fadeInUp" data-wow-delay="0.4s">
                <form action="contact.php" method="POST" class="ajax-contact">
                    <span class="sec-subtitle" data-translate="for_any_query">For Any Query</span>
                    <h2 class="sec-title mb-4 pb-2" data-translate="send_message">Send Us a Message</h2>
                    <div class="row gx-20">
                        <div class="col-md-6 form-group"><input type="text" data-translate-placeholder="your_name" placeholder="Your Name" name="name"
                                id="name" class="form-control style4"></div>
                        <div class="col-md-6 form-group"><input type="email" data-translate-placeholder="your_email" placeholder="Your Email" name="email"
                                id="email" class="form-control style4"></div>
                        <div class="col-md-6 form-group"><input type="number" data-translate-placeholder="phone_no" placeholder="Phone No" name="phone"
                                id="phone" class="form-control style4"></div>
                        <div class="col-md-6 form-group"><input type="text" data-translate-placeholder="your_subject" placeholder="Your Subject" name="subject"
                                id="subject" class="form-control style4"></div>
                        <div class="form-group col-12"><textarea data-translate-placeholder="message" placeholder="Message" name="message" id="message"
                                class="form-control style4"></textarea></div>
                        <div class="col-12"><button class="vs-btn" type="submit" data-translate="send">Send Message</button></div>
                    </div>
                </form>
                <?php
    ...
    <div class="container">
        <div class="row gx-0">
            <div class="col-md-4 contact-box wow fadeInUp" data-wow-delay="0.3s">
                ...
                <h3 class="contact-box__title h5" data-translate="office_address">Office Address:</h3>
            ...
            <div class="col-md-4 contact-box wow fadeInUp" data-wow-delay="0.4s">
                ...
                <h3 class="contact-box__title h5" data-translate="call_us_for_help">Call Us For Help:</h3>
            ...
            <div class="col-md-4 contact-box wow fadeInUp" data-wow-delay="0.5s">
                ...
                <h3 class="contact-box__title h5" data-translate="mail_info">Mail info:</h3>
